...
% iii is the cancer index

clearvars -except all_exp all_cna all_mirna all_clin all_pat CCC_set iii 
...
%% save the file
save(sprintf('surv_analysis_mu1_lam0001_%d_norandom.mat', iii),  'clus_ind_set12', 'gp_title11', 'surv_time', 'surv_stat', 'ck_set')
end
...
for iii=setdiff(1:33, [10 11 12 16 20 24 25 27 29 31 33]); 
...
load(sprintf('surv_analysis_performance_mu1_lam0001_%d_norandom.mat', iiii(ii)))
    for jj=1:tot_num
