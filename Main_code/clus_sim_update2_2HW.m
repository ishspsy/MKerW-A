function  [P_set,V_set,V_tot, ck, W_set, Wg_set]=clus_sim_update2_2HW(CCC, c,rho, n, K, p,q, gg, lam, mu, eta, W_euc_double)   
...
% Update P,Q,Gamma
[~, P_set, Q_set, Gamma_set, ~]=clus_sim_update0_2HW(CCC, ck, c, rho, lam, mu, eta, kernel_ini_set2);
