function[diff_area]=diff_area_func(CCC, pd1_A_set,pd1_B_set, bord, bordmin);
...
%% Ouput
% diff_area is the CCC by CCC matrices, where (i,j) component represents the absolute area difference between curves corresponding to the i-th and j-th inferred clusters.
...
for ii=1:CCC; 
    ...
    diff_area(ii,jj)=area_mid1+area_mid2;
    end
    end
end
