function print_gamma(time, status, Z,pars, SE, CI, Zscores, pvalues, minimizer,exitflag,gval, fminconhess)
...
fprintf('Scale:        ')
        i=i+1;
        myrow=[parms(i) SEs(i) CIs(i,1) CIs(i,2)];
        printmyrow(myrow)
fprintf('\n')
fprintf('Shape:        ')
        i=i+1;
